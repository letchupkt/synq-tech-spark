        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="relative w-full max-w-md aspect-square rounded-lg overflow-hidden mx-auto border-4 border-primary/20">
              <img src="https://github.com/letchupkt/synq-tech-spark/blob/main/src/data/images/team/founder.png" alt="Lakshmikanthan K" className="absolute inset-0 w-full h-full object-cover"/>
